...
(function(theme, $) {
	...
	// ----- Fix ipad responsive 280817
	if ( typeof $.browser !== 'undefined' && $.browser.mobile && $html.hasClass('fixed') /*[[*/ && $(window).width() < 768 /*]]*/) {
		$html.removeClass( 'fixed' ).addClass( 'scroll' );
	}
	// ----- End: Fix ipad responsive 280817
...
//		customScroll: ( !Modernizr.overflowscrolling && !isAndroid && $.fn.nanoScroller !== 'undefined'),
		...
		build: function() {
			...
			if ( typeof $.browser !== 'undefined' && $.browser.mobile /*[[*/ && $(window).width() < 768 /*]]*/) {
